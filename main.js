...
const backBtn = `<div class="mt-5 d-flex justify-content-center mb-5"><a href="javascript:history.back()" class="bg-danger p-2 border-0 text-white text-center text-decoration-none rounded">Back</a></div>`
